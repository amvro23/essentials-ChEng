from thermodynamics_nist import Reaction, Mixture, \
      enthalpy_rxn_kj_mol, entropy_rxn_kj_mol, gibbs_rxn_kj_mol, equilibrium_constant, \
            partial_enthalpies_kj_mol, cpi_j_mol_K, ci_mol_m3, c_total_mol_m3, d_mix_kg_m3, mr_mix_kg_mol
import numpy as np
...
reaction_DRM = Reaction(coeffs_DRM, HF298_DRM, SF298_DRM, v_DRM)

reaction_DRM.print_params()

print("DRM enthalpy at {} K is {}".format(T, enthalpy_rxn_kj_mol(reaction_DRM, T)[0]), "kJ/mol")
print("DRM entropy at {} K is {}".format(T, entropy_rxn_kj_mol(reaction_DRM, T)[0]), "kJ/mol/K")
print("DRM gibbs energy at {} K is {}".format(T, gibbs_rxn_kj_mol(reaction_DRM, T)[0]), "kJ/mol")
print("DRM Keq at {} K is {}".format(T, equilibrium_constant(reaction_DRM, T)[0]))
...
# create a reaction object and print its stored parameters:
reaction_SRM1 = Reaction(coeffs_SRM1, HF298_SRM1, SF298_SRM1, v_SRM1)

reaction_SRM1.print_params()

print("SRM1 enthalpy at {} K is {}".format(T, enthalpy_rxn_kj_mol(reaction_SRM1, T)[0]), "kJ/mol")
print("SRM1 entropy at {} K is {}".format(T, entropy_rxn_kj_mol(reaction_SRM1, T)[0]), "kJ/mol/K")
print("SRM1 gibbs energy at {} K is {}".format(T, gibbs_rxn_kj_mol(reaction_SRM1, T)[0]), "kJ/mol")
print("SRM1 Keq at {} K is {}".format(T, equilibrium_constant(reaction_SRM1, T)[0]))
...
# create a reaction object and print its stored parameters:
reaction_SRM2 = Reaction(coeffs_SRM2, HF298_SRM2, SF298_SRM2, v_SRM2)

reaction_SRM2.print_params()

print("SRM2 enthalpy at {} K is {}".format(T, enthalpy_rxn_kj_mol(reaction_SRM2, T)[0]), "kJ/mol")
print("SRM2 entropy at {} K is {}".format(T, entropy_rxn_kj_mol(reaction_SRM2, T)[0]), "kJ/mol/K")
print("SRM2 gibbs energy at {} K is {}".format(T, gibbs_rxn_kj_mol(reaction_SRM2, T)[0]), "kJ/mol")
print("SRM2 Keq at {} K is {}".format(T, equilibrium_constant(reaction_SRM2, T)[0]))
...
# create a reaction object and print its stored parameters:
reaction_WGS = Reaction(coeffs_WGS, HF298_WGS, SF298_WGS, v_WGS)

reaction_WGS.print_params()

print("WGS enthalpy at {} K is {}".format(T, enthalpy_rxn_kj_mol(reaction_WGS, T)[0]), "kJ/mol")
print("WGS entropy at {} K is {}".format(T, entropy_rxn_kj_mol(reaction_WGS, T)[0]), "kJ/mol/K")
print("WGS gibbs energy at {} K is {}".format(T, gibbs_rxn_kj_mol(reaction_WGS, T)[0]), "kJ/mol")
print("WGS Keq at {} K is {}".format(T, equilibrium_constant(reaction_WGS, T)[0]))
...
species_enthalpy = Mixture(coeffs_species, HF298_species, y_species, Mr_species)

species_enthalpy.print_params()

print("partial enthalpies of species in the mixture at {} K is \n{}".format(T, partial_enthalpies_kj_mol(species_enthalpy, 873.15)), "kJ/mol")

#---------------------------------------------------------------------------------------------------------------------
# create an object with mixture parameters
species_Cp = Mixture(coeffs_species[:, :-3], HF298_species, y_species, Mr_species)

species_Cp.print_params()

print("partial specific heats of species in the mixture at {} K is {}".format(T, cpi_j_mol_K(species_Cp, T)), "kJ/mol")

print("concentrations of species in the mixture at {} K and {} bar is {}".format(T, P, ci_mol_m3(species_Cp, T, P)), "mol/m3")

print("total concentration of mixture at {} K and {} bar is {}".format(T, P, c_total_mol_m3(species_Cp, T, P)), "mol/m3")

print("density of the mixture at {} K and {} bar is {}".format(T, P, d_mix_kg_m3(species_Cp, T, P)), "kg/m3")

print("molar mass of the mixture at {} K and {} bar is {}".format(T, P, mr_mix_kg_mol(species_Cp)), "in kg/mol")
