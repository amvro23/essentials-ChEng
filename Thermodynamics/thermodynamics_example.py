...
print("DRM Keq at {} K is {}".format(T, thermodynamics.equilibrium_constant(reaction_DRM, T)[0]))
...
print("SRM1 Keq at {} K is {}".format(T, thermodynamics.equilibrium_constant(reaction_SRM1, T)[0]))
...
print("SRM2 Keq at {} K is {}".format(T, thermodynamics.equilibrium_constant(reaction_SRM2, T)[0]))
...
print("WGS Keq at {} K is {}".format(T, thermodynamics.equilibrium_constant(reaction_WGS, T)[0]))
